                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @auth
                        ...
                        @if(in_array(auth()->user()->role, ['sales', 'manager']))
                            ...
                            @else
                                <x-nav-link :href="route('manager.projects.index')"
                                    :active="request()->routeIs('manager.projects.*')">
                                    {{ __('Projects') }}
                                </x-nav-link>
                            @endif
                ...
                @else
                    <div class="flex space-x-4">
                        ...
                        <a href="{{ route('register') }}"
                            class="bg-blue-600 hover:bg-blue-700 text-white px-3 py-2 rounded-md text-sm font-medium">Register</a>
                    </div>
                @endauth
            </div>
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            @auth
                ...
                @if(in_array(auth()->user()->role, ['sales', 'manager']))
                    ...
                    @else
                        <x-responsive-nav-link :href="route('manager.projects.index')"
                            :active="request()->routeIs('manager.projects.*')">
                            {{ __('Projects') }}
                        </x-responsive-nav-link>
                    @endif
