                ...
                <form method="POST" action="{{ route('services.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea id="description" 
                                ...
                                placeholder="Deskripsi detail tentang service ini">{{ old('description') }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea id="features" 
                                ...
                                rows="3"
                                class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"
                                placeholder="Contoh: Unlimited bandwidth, 24/7 support, Free installation">{{ old('features') }}</textarea>
